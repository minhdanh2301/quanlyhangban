                        ...
                        <div class="col-lg-5 col-md-5 col-sm-4 col-xs-12">
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane active" id="thumbnail_1">
                                        <div class="single-product-image">
                                            <img src="imgsp/swt2.1.jpg" alt="single-product-image" />
                                            <a class="new-mark-box" href="#">new</a>
                                            <a class="fancybox" href="imgsp/swt2.1.jpg"
                                    ...
                                    <div class="tab-pane" id="thumbnail_2">
                                        <div class="single-product-image">
                                            <img src="imgsp/swt2.2.jpg" alt="single-product-image" />
                                            <a class="new-mark-box" href="#">new</a>
                                            <a class="fancybox" href="imgsp/swt2.2.jpg"
                                                data-fancybox-group="gallery"><span class="btn large-btn">View larger <i
                                                        class="fa fa-search-plus"></i></span></a>
                                        </div>
                                    </div>
                                    <div class="tab-pane" id="thumbnail_3">
                                        <div class="single-product-image">
                                            <img src="imgsp/swt2.3.jpg" alt="single-product-image" />
                                            <a class="new-mark-box" href="#">new</a>
                                            <a class="fancybox" href="imgsp/swt2.3.jpg"
                                                data-fancybox-group="gallery"><span class="btn large-btn">View larger <i
                                                        class="fa fa-search-plus"></i></span></a>
                                        </div>
                                    </div>
                                    <div class="tab-pane" id="thumbnail_3">
                                        <div class="single-product-image">
                                            <img src="imgsp/swt2.4.jpg" alt="single-product-image" />
                                            <a class="new-mark-box" href="#">new</a>
                                            <a class="fancybox" href="imgsp/swt2.4.jpg"
                                                data-fancybox-group="gallery"><span class="btn large-btn">View larger <i
                                                        class="fa fa-search-plus"></i></span></a>
                                        </div>
                                    </div>
                                    <div class="tab-pane" id="thumbnail_3">
                                        <div class="single-product-image">
                                            <img src="imgsp/swt2.5.jpg" alt="single-product-image" />
                                            <a class="new-mark-box" href="#">new</a>
                                            <a class="fancybox" href="imgsp/swt2.5.jpg"
                                                data-fancybox-group="gallery"><span class="btn large-btn">View larger <i
                                                        class="fa fa-search-plus"></i></span></a>
                                        </div>
                                    </div>
                                    <div class="tab-pane" id="thumbnail_3">
                                        <div class="single-product-image">
                                            <img src="imgsp/swt2.6.jpg" alt="single-product-image" />
                                            <a class="new-mark-box" href="#">new</a>
                                            <a class="fancybox" href="imgsp/swt2.6.jpg"
                                                data-fancybox-group="gallery"><span class="btn large-btn">View larger <i
                                                        class="fa fa-search-plus"></i></span></a>
                                        </div>
                                    </div>
                            ...
                            <div class="select-product">
                                ...
                                <ul class="nav nav-tabs select-product-tab bxslider">
                                    <li class="active">
                                        <a href="#thumbnail_1" data-toggle="tab"><img src="imgsp/swt2.1.jpg"
                                                alt="pro-thumbnail" /></a>
                                    </li>
                                    <li>
                                        <a href="#thumbnail_2" data-toggle="tab"><img src="imgsp/swt2.2.jpg"
                                                alt="pro-thumbnail" /></a>
                                    </li>
                                    <li>
                                        <a href="#thumbnail_3" data-toggle="tab"><img src="imgsp/swt2.3.jpg"
                                                alt="pro-thumbnail" /></a>
                                    </li>
                                    <li>
                                        <a href="#thumbnail_3" data-toggle="tab"><img src="imgsp/swt2.4.jpg"
                                                alt="pro-thumbnail" /></a>
                                    </li>
                                    <li>
                                        <a href="#thumbnail_3" data-toggle="tab"><img src="imgsp/swt2.5.jpg"
                                                alt="pro-thumbnail" /></a>
                                    </li>
                                    <li>
                                        <a href="#thumbnail_3" data-toggle="tab"><img src="imgsp/swt2.6.jpg"
                                                alt="pro-thumbnail" /></a>
                                    </li>
                                </ul>
                            </div>
                                        ...
                                        <div class="item">
                                            <div class="single-product-item">
                                                ...
                                                <div class="product-info">
                                                    ...
                                                    <a href="swt4.php">Printed Dress</a>
                                                    <div class="price-box">
                                        ...
                                        <div class="item">
                                            <div class="single-product-item">
                                                ...
                                                <div class="product-info">
                                                    ...
                                                    <a href="bag2.php">Printed Summer Dr...</a>
                                                    <div class="price-box">
                                        ...
                                        <div class="item">
                                            <div class="single-product-item">
                                                ...
                                                <div class="product-info">
                                                    ...
                                                    <a href="shoe4.php">Printed Summer</a>
                                                    <div class="price-box">

                        ...
                        <div class="col-lg-5 col-md-5 col-sm-4 col-xs-12">
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane active" id="thumbnail_1">
                                        <div class="single-product-image">
                                            <img src="imgsp/somi3.1.jpg" alt="single-product-image" />
                                            <a class="new-mark-box" href="#">new</a>
                                            <a class="fancybox" href="imgsp/somi3.1.jpg"
                                    ...
                                    <div class="tab-pane" id="thumbnail_2">
                                        <div class="single-product-image">
                                            <img src="imgsp/somi3.2.jpg" alt="single-product-image" />
                                            <a class="new-mark-box" href="#">new</a>
                                            <a class="fancybox" href="imgsp/somi3.2.jpg"
                                                data-fancybox-group="gallery"><span class="btn large-btn">View larger <i
                                                        class="fa fa-search-plus"></i></span></a>
                                        </div>
                                    </div>
                                    <div class="tab-pane" id="thumbnail_3">
                                        <div class="single-product-image">
                                            <img src="imgsp/somi3.3.jpg" alt="single-product-image" />
                                            <a class="new-mark-box" href="#">new</a>
                                            <a class="fancybox" href="imgsp/somi3.3.jpg"
                                                data-fancybox-group="gallery"><span class="btn large-btn">View larger <i
                                                        class="fa fa-search-plus"></i></span></a>
                                        </div>
                                    </div>
                                    <div class="tab-pane" id="thumbnail_3">
                                        <div class="single-product-image">
                                            <img src="imgsp/somi3.4.jpg" alt="single-product-image" />
                                            <a class="new-mark-box" href="#">new</a>
                                            <a class="fancybox" href="imgsp/somi3.4.jpg"
                                                data-fancybox-group="gallery"><span class="btn large-btn">View larger <i
                                                        class="fa fa-search-plus"></i></span></a>
                                        </div>
                                    </div>
                            ...
                            <div class="select-product">
                                ...
                                <ul class="nav nav-tabs select-product-tab bxslider">
                                    <li class="active">
                                        <a href="#thumbnail_1" data-toggle="tab"><img src="imgsp/somi3.1.jpg"
                                                alt="pro-thumbnail" /></a>
                                    </li>
                                    <li>
                                        <a href="#thumbnail_2" data-toggle="tab"><img src="imgsp/somi3.2.jpg"
                                                alt="pro-thumbnail" /></a>
                                    </li>
                                    <li>
                                        <a href="#thumbnail_3" data-toggle="tab"><img src="imgsp/somi3.3.jpg"
                                                alt="pro-thumbnail" /></a>
                                    </li>
                                    <li>
                                        <a href="#thumbnail_3" data-toggle="tab"><img src="imgsp/somi3.4.jpg"
                                                alt="pro-thumbnail" /></a>
                                    </li>
                                        ...
                                        <div class="item">
                                            <div class="single-product-item">
                                                ...
                                                <div class="product-info">
                                                    ...
                                                    <a href="thun2.php">ÁO THUN NAM ARI ATS02</a>
                                                    <div class="price-box">
                                        ...
                                        <div class="item">
                                            <div class="single-product-item">
                                                ...
                                                <div class="product-info">
                                                    ...
                                                    <a href="thun10.php">ÁO THUN NAM ARI ATS10</a>
                                                    <div class="price-box">
                                        ...
                                        <div class="item">
                                            <div class="single-product-item">
                                                ...
                                                <div class="product-info">
                                                    ...
                                                    <a href="quanden.php">QUẦN JEAN NÚT MÀU TRƠN</a>
                                                    <div class="price-box">
                        ...
                        <ul>
                            <li>
                                ...
                                <div class="r-sidebar-pro-content">
                                    <h5><a href="somi1.php">LỆCH SHIRT</a></h5>
                            ...
                            <li>
                                ...
                                <div class="r-sidebar-pro-content">
                                    <h5><a href="bag3.php">TÚI DA LATA BAL39BN</a></h5>
                                    <span class="price">$22.95</span><BR>
                                        <span class="old-price">$27.00</span>
                                </div>
                            </li>
                            <li>
                                ...
                                <div class="r-sidebar-pro-content">
                                    <h5><a href="shoe1.php">GIÀY NAM DA THẬT- EGTM06 </a></h5>
                                    <span class="price">$22.95</span><BR>
                                        <span class="old-price">$27.00</span>
                                </div>
                            </li>
                            <li>
                                ...
                                <div class="r-sidebar-pro-content">
                                    <h5><a href="thun12.php">ÁO THUN NAM ARI ATS12 </a></h5>
                                    <span class="price">$22.95</span><BR>
                                        <span class="old-price">$27.00</span>
                                </div>
                            </li>

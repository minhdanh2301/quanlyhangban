										...
										<div class="fotter-menu-widget">
											<div class="single-f-widget">
												...
												<ul>
													...
													<li><a href="men.html"><i class="fa fa-angle-double-right"></i>Men</a></li>
													<li><a href="clothing.html"><i class="fa fa-angle-double-right"></i>clothing</a></li>
				...
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<div class="copy-right">
							<address>Copyright © <?php  echo date ("Y")?> <a href="http://bootexperts.com/">BootExperts</a> All Rights Reserved</address>
						</div>

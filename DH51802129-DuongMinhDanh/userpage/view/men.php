							...
							<div class="product-category-header">
								<div class="category-header-image">
									...
									<div class="category-header-text">
										...
										<p>This category includes all the basics of your wardrobe and much more:<br /> shoes, accessories, printed t-shirts, feminine dresses, men's jeans!</p>
									</div>									
								</div>
							</div>
							...
							<div class="product-shooting-area">
								<div class="product-shooting-bar">
									...
									<div class="view-systeam">
										...
										<ul>
											<li class="active"><a href="women.php"><i class="fa fa-th-large"></i></a><br />Grid</li>
							...
							<div class="row">
								<ul class="gategory-product">
									...
									<li class="gategory-product-list col-lg-3 col-md-4 col-sm-6 col-xs-12">
										<div class="single-product-item">
											<div class="product-image">
												...
												<a href="somi1.php" class="new-mark-box">new</a>
									...
									<li class="gategory-product-list col-lg-3 col-md-4 col-sm-6 col-xs-12">
										<div class="single-product-item">
											<div class="product-image">
												...
												<a href="somi2.php" class="new-mark-box">sale!</a>
												<div class="overlay-content">
													<ul>
														<li><a href="#" title="Quick view"><i class="fa fa-search"></i></a></li>
														<li><a href="#" title="Quick view"><i class="fa fa-shopping-cart"></i></a></li>
											...
											<div class="product-info">
												...
												<a href="somi2.php">GRAND SHIRT</a>
												<div class="price-box">
									...
									<li class="gategory-product-list col-lg-3 col-md-4 col-sm-6 col-xs-12">
										<div class="single-product-item">
											<div class="product-image">
												...
												<a href="somi3.php" class="new-mark-box">sale!</a>
												<div class="overlay-content">
													<ul>
														<li><a href="#" title="Quick view"><i class="fa fa-search"></i></a></li>
														<li><a href="#" title="Quick view"><i class="fa fa-shopping-cart"></i></a></li>
											...
											<div class="product-info">
												...
												<a href="somi3.php">CLASSIC SHIRT
												</a>
												<div class="price-box">
									...
									<li class="gategory-product-list col-lg-3 col-md-4 col-sm-6 col-xs-12">
										<div class="single-product-item">
											<div class="product-image">
												...
												<a href="somi4.php" class="new-mark-box">new</a>
												<div class="overlay-content">
													<ul>
														<li><a href="#" title="Quick view"><i class="fa fa-search"></i></a></li>
														<li><a href="#" title="Quick view"><i class="fa fa-shopping-cart"></i></a></li>
											...
											<div class="product-info">
												...
												<a href="somi4.php">Áo Sơmi Tay Dài Sọc Dọc</a>
												<div class="price-box">
									...
									<li class="gategory-product-list col-lg-3 col-md-4 col-sm-6 col-xs-12">
										<div class="single-product-item">
											<div class="product-image">
												...
												<a href="swt1.php" class="new-mark-box">new</a>
												<div class="overlay-content">
													<ul>
														<li><a href="#" title="Quick view"><i class="fa fa-search"></i></a></li>
														<li><a href="#" title="Quick view"><i class="fa fa-shopping-cart"></i></a></li>
											...
											<div class="product-info">
												...
												<a href="swt1.php">Xì Que Đờ Xoài - XQX</a>
												<div class="price-box">
									...
									<li class="gategory-product-list col-lg-3 col-md-4 col-sm-6 col-xs-12">
										<div class="single-product-item">
											<div class="product-image">
												...
												<a href="swt2.php" class="new-mark-box">new</a>
												<div class="overlay-content">
													<ul>
														<li><a href="#" title="Quick view"><i class="fa fa-search"></i></a></li>
														<li><a href="#" title="Quick view"><i class="fa fa-shopping-cart"></i></a></li>
											...
											<div class="product-info">
												...
												<a href="swt2.php">LVS SWEATER 0.5 FLORAL</a>
												<div class="price-box">
									...
									<li class="gategory-product-list col-lg-3 col-md-4 col-sm-6 col-xs-12">
										<div class="single-product-item">
											<div class="product-image">
												...
												<a href="swt3.php" class="new-mark-box">new</a>
												<div class="overlay-content">
													<ul>
														<li><a href="#" title="Quick view"><i class="fa fa-search"></i></a></li>
														<li><a href="#" title="Quick view"><i class="fa fa-shopping-cart"></i></a></li>
											...
											<div class="product-info">
												...
												<a href="swt3.php">LEVENTS STARS SPACE </a>
												<div class="price-box">
									...
									<li class="gategory-product-list col-lg-3 col-md-4 col-sm-6 col-xs-12">
										<div class="single-product-item">
											<div class="product-image">
												...
												<a href="swt4.php" class="new-mark-box">new</a>
												<div class="overlay-content">
													<ul>
														<li><a href="#" title="Quick view"><i class="fa fa-search"></i></a></li>
														<li><a href="#" title="Quick view"><i class="fa fa-shopping-cart"></i></a></li>
											...
											<div class="product-info">
												...
												<a href="swt4.php">INSPIRATION SWE</a>
												<div class="price-box">
									...
									<li class="gategory-product-list col-lg-3 col-md-4 col-sm-6 col-xs-12">
										<div class="single-product-item">
											<div class="product-image">
												...
												<a href="bag1.php" class="new-mark-box">new</a>
												<div class="overlay-content">
													<ul>
														<li><a href="#" title="Quick view"><i class="fa fa-search"></i></a></li>
														<li><a href="#" title="Quick view"><i class="fa fa-shopping-cart"></i></a></li>
											...
											<div class="product-info">
												...
												<a href="bag1.php">Túi Xách Golf Nam </a>
												<div class="price-box">
													<span class="price">$16.51</span>
												</div>
											</div>
									...
									<li class="gategory-product-list col-lg-3 col-md-4 col-sm-6 col-xs-12">
										<div class="single-product-item">
											<div class="product-image">
												...
												<a href="bag2.php" class="new-mark-box">new</a>
												<div class="overlay-content">
													<ul>
														<li><a href="#" title="Quick view"><i class="fa fa-search"></i></a></li>
														<li><a href="#" title="Quick view"><i class="fa fa-shopping-cart"></i></a></li>
											...
											<div class="product-info">
												...
												<a href="bag2.php">Cặp da công sở Lata CA17N 
												</a>
												<div class="price-box">
									...
									<li class="gategory-product-list col-lg-3 col-md-4 col-sm-6 col-xs-12 hidden-md">
										<div class="single-product-item">
											<div class="product-image">
												...
												<a href="bag3.php" class="new-mark-box">sale!</a>
												<div class="overlay-content">
													<ul>
														<li><a href="#" title="Quick view"><i class="fa fa-search"></i></a></li>
														<li><a href="#" title="Quick view"><i class="fa fa-shopping-cart"></i></a></li>
											...
											<div class="product-info">
												...
												<a href="bag3.php">Balo da Lata BAL39BN </a>
												<div class="price-box">
													<span class="price">$23.40</span>
													<span class="old-price">$26.00</span>
												</div>
									...
									<li class="gategory-product-list col-lg-3 col-md-4 col-sm-6 col-xs-12">
										<div class="single-product-item">
											<div class="product-image">
												...
												<a href="bag4.php" class="new-mark-box">new</a>
												<div class="overlay-content">
													<ul>
														<li><a href="#" title="Quick view"><i class="fa fa-search"></i></a></li>
														<li><a href="#" title="Quick view"><i class="fa fa-shopping-cart"></i></a></li>
											...
											<div class="product-info">
												...
												<a href="bag4.php">Túi Xách Lifestyle Unisex</a>
												<div class="price-box">
													<span class="price">$26.00</span>
												</div>
											</div>
									...
									<li class="gategory-product-list col-lg-3 col-md-4 col-sm-6 col-xs-12">
										<div class="single-product-item">
											<div class="product-image">
												...
												<a href="shoe1.php" class="new-mark-box">new</a>
												<div class="overlay-content">
													<ul>
														<li><a href="#" title="Quick view"><i class="fa fa-search"></i></a></li>
														<li><a href="#" title="Quick view"><i class="fa fa-shopping-cart"></i></a></li>
											...
											<div class="product-info">
												...
												<a href="shoe1.php">GIÀY NAM DA THẬT – EGTM6 </a>
												<div class="price-box">
													<span class="price">$16.40</span>
												</div>
											</div>
									...
									<li class="gategory-product-list col-lg-3 col-md-4 col-sm-6 col-xs-12">
										<div class="single-product-item">
											<div class="product-image">
												...
												<a href="shoe2.php" class="new-mark-box">new</a>
												<div class="overlay-content">
													<ul>
														<li><a href="#" title="Quick view"><i class="fa fa-search"></i></a></li>
														<li><a href="#" title="Quick view"><i class="fa fa-shopping-cart"></i></a></li>
											...
											<div class="product-info">
												...
												<a href="shoe2.php">GIÀY NAM SNEAKER DA THẬT– EGTM20
												</a>
												<div class="price-box">
													<span class="price">$16.51</span>
												</div>
									...
									<li class="gategory-product-list col-lg-3 col-md-4 col-sm-6 col-xs-12">
										<div class="single-product-item">
											<div class="product-image">
												...
												<a href="shoe3.php" class="new-mark-box">sale!</a>
												<div class="overlay-content">
													<ul>
														<li><a href="#" title="Quick view"><i class="fa fa-search"></i></a></li>
														<li><a href="#" title="Quick view"><i class="fa fa-shopping-cart"></i></a></li>
											...
											<div class="product-info">
												...
												<a href="shoe3.php">GIÀY NAM SNEAKER DA THẬT- EGTM5</a>
												<div class="price-box">
													<span class="price">$22.95</span>
													<span class="old-price">$27.00</span>
												</div>
									...
									<li class="gategory-product-list col-lg-3 col-md-4 col-sm-6 col-xs-12">
										<div class="single-product-item">
											<div class="product-image">
												<a href="shoe4.php"><img src="imgsp/shoe4.1.jpg" alt="product-image" /></a>
												<a href="shoe4.php" class="new-mark-box">sale!</a>
												<div class="overlay-content">
													<ul>
														<li><a href="#" title="Quick view"><i class="fa fa-search"></i></a></li>
														<li><a href="#" title="Quick view"><i class="fa fa-shopping-cart"></i></a></li>
											...
											<div class="product-info">
												...
												<a href="shoe4.php">GIÀY NAM SNEAKER DA THẬT- EGTM21</a>
												<div class="price-box">
													<span class="price">$23.40</span>
													<span class="old-price">$26.00</span>
												</div>

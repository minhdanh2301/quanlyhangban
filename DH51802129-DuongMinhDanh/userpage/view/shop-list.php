							...
							<div class="product-shooting-area">
								<div class="product-shooting-bar">
									...
									<div class="view-systeam">
										...
										<ul>
											<li><a href="women.php"><i class="fa fa-th-large"></i></a><br />Grid</li>
											<li class="active"><a href="shop-list.php"><i class="fa fa-th-list"></i></a><br />List</li>
										</ul>
									</div>
									<!-- VIEW-SYSTEAM END -->
								</div>
								...
								<ul class="gategory-product">
										...
										<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
											<div class="single-product-item">
												<div class="product-image">
													<a href="single-product.php"><img src="img/product/sale/3.jpg" alt="product-image" /></a>
												...
												<div class="single-product-item">
													<div class="product-info">
														<div class="customar-comments-box">
															<a href="single-product.php">Faded Short Sleeves T-shirt </a>
									...
									<li class="cat-product-list">
										<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
											<div class="single-product-item">
												<div class="product-image">
													<a href="single-product.php"><img src="img/product/sale/1.jpg" alt="product-image" /></a>
													<a href="single-product.php" class="new-mark-box">Sale!</a>
												</div>
											</div>
										</div>
										<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
											<div class="list-view-content">
												<div class="single-product-item">
													<div class="product-info">
														<div class="customar-comments-box">
															<a href="single-product.php">Blouse</a>
															<div class="rating-box">
																<i class="fa fa-star"></i>
																<i class="fa fa-star"></i>
																<i class="fa fa-star"></i>
									...
									<li class="cat-product-list">
										<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
											<div class="single-product-item">
												<div class="product-image">
													<a href="single-product.php"><img src="img/product/sale/9.jpg" alt="product-image" /></a>
													<a href="single-product.php" class="new-mark-box">Sale!</a>
												</div>
											</div>
										</div>
										<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
											<div class="list-view-content">
												<div class="single-product-item">
													<div class="product-info">
														<div class="customar-comments-box">
															<a href="single-product.php">Printed Dress</a>
															<div class="rating-box">
																<i class="fa fa-star"></i>
																<i class="fa fa-star"></i>
																<i class="fa fa-star"></i>
									...
									<li class="cat-product-list">
										<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
											<div class="single-product-item">
												<div class="product-image">
													<a href="single-product.php"><img src="img/product/sale/5.jpg" alt="product-image" /></a>
													<a href="single-product.php" class="new-mark-box">Sale!</a>
												</div>
											</div>
										</div>
									...
									<li class="cat-product-list">
										<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
											<div class="single-product-item">
												<div class="product-image">
													<a href="single-product.php"><img src="img/product/sale/12.jpg" alt="product-image" /></a>
													<a href="single-product.php" class="new-mark-box">new</a>
												</div>
											</div>
										</div>
										<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
											<div class="list-view-content">
												<div class="single-product-item">
													<div class="product-info">
														<div class="customar-comments-box">
															<a href="single-product.php">Printed Summer Dress </a>
															<div class="rating-box">
																<i class="fa fa-star"></i>
																<i class="fa fa-star"></i>
																<i class="fa fa-star"></i>
									...
									<li class="cat-product-list">
										<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
											<div class="single-product-item">
												<div class="product-image">
													<a href="single-product.php"><img src="img/product/sale/13.jpg" alt="product-image" /></a>
													<a href="single-product.php" class="new-mark-box">new</a>
												</div>
											</div>
										</div>
									...
									<li class="cat-product-list">
										<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
											<div class="single-product-item">
												<div class="product-image">
													<a href="single-product.php"><img src="img/product/sale/11.jpg" alt="product-image" /></a>
													<a href="single-product.php" class="new-mark-box">new</a>
												</div>
											</div>
										</div>
									...
									<li class="cat-product-list">
										<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
											<div class="single-product-item">
												<div class="product-image">
													<a href="single-product.php"><img src="img/product/sale/2.jpg" alt="product-image" /></a>
													<a href="single-product.php" class="new-mark-box">new</a>
												</div>
											</div>
										</div>
									...
									<li class="cat-product-list">
										<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
											<div class="single-product-item">
												<div class="product-image">
													<a href="single-product.php"><img src="img/product/sale/4.jpg" alt="product-image" /></a>
													<a href="single-product.php" class="new-mark-box">new</a>
												</div>
											</div>
										</div>
									...
									<li class="cat-product-list">
										<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
											<div class="single-product-item">
												<div class="product-image">
													<a href="single-product.php"><img src="img/product/sale/7.jpg" alt="product-image" /></a>
													<a href="single-product.php" class="new-mark-box">new</a>
												</div>
											</div>
										</div>
										<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
											<div class="list-view-content">
												<div class="single-product-item">
													<div class="product-info">
														<div class="customar-comments-box">
															<a href="single-product.php">Printed Chiffon Dress</a>
															<div class="rating-box">
																<i class="fa fa-star"></i>
																<i class="fa fa-star"></i>
																<i class="fa fa-star"></i>
									...
									<li class="cat-product-list">
										<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
											<div class="single-product-item">
												<div class="product-image">
													<a href="single-product.php"><img src="img/product/sale/10.jpg" alt="product-image" /></a>
													<a href="single-product.php" class="new-mark-box">new</a>
												</div>
											</div>
										</div>
									...
									<li class="cat-product-list">
										<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
											<div class="single-product-item">
												<div class="product-image">
													<a href="single-product.php"><img src="img/product/sale/6.jpg" alt="product-image" /></a>
													<a href="single-product.php" class="new-mark-box">new</a>
												</div>
											</div>
										</div>

                        ...
                        <div class="card-body card-block">
                            <form action="../controller/sanphamController.php" method="post" enctype="multipart/form-data" class="form-horizontal">
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-9"><input type="number" id="txt_sl" name="txt_sl" class="form-control"></div>
                                </div>
                                <div class="row form-group">
                                    <div class="col col-md-3"><label for="textarea-input" class=" form-control-label">Mô tả</label></div>
                                    <div class="col-12 col-md-9"><textarea type="text" id="txt_mota" name="txt_mota" class="form-control"></textarea></div>
                                </div>
                                <div class="row form-group">
                                    <div class="col col-md-3"><label for="text-input" class=" form-control-label">Địa chỉ</label></div>
                                    <div class="col-12 col-md-9"><input type="text" id="txt_dchi" name="txt_dchi" class="form-control"></div>
                                </div>
                                <div class="row form-group">
                                ...
                                <button type="submit" name="sp_group_action" value="sp_create" class="btn btn-primary">
